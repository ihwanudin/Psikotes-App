...
| `01a0890c-53b1-7bf1-a6b3-59addda5b722` (`1747`, continued by `/root/review_f9_lifecycle`) | F9 audit-retention repair | `AuthenticateSelectionResultPoll.php` plus `GenericAssessmentResultPollHttpTest.php` only | Replace only denied-poll authentication audit expiry with five-year Audit policy | Manual proof through invoice-claim slices are integrated through `f2add06`; integrated-checkout is integrated as `b5adb83`. Checkout lifecycle, handoff issuance, session establishment, invoice outcome/permit, reservation, and assessment activation audits are integrated as `079f9bc`, `91b048d`, `5a15950`, `e888155`, `ab3411f`, `1ce2cce`, and `5b90b0f`. Funding-policy audit `5313e27` + neutral fixture `6196a98` are integrated as `477cae5` + `7c73a69` with main 43/167. Denied-poll audit slice is active from worker baseline `6196a98`; outbox/business two-year retention remains unchanged, F2 files remain exclusive, and no route, config, feature activation, provider call, or live integration is owned here |
