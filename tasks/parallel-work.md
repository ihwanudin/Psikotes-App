...
| F9 pre-existing ESLint blocker audit | `/root/audit_legacy_case_identity` | Read-only lint output and Git-history inspection | Partition the 210 cross-lane errors into safe, non-overlapping repair slices without running auto-fix | active from baseline `3d1d97e`; no file ownership |
