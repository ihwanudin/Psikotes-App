...
| `01a0890c-53b1-7bf1-a6b3-59addda5b722` (`1747`, replacement for inactive `01a0881b-85ce-7f43-91d5-dd84fe064064`) | F9 invitation retention | `IssueAssessmentInvitation.php` and its focused test only; no migration/delete/scheduler | Audit and, only if the existing five-year/privacy/idempotency contract is proven, replace ad-hoc expiry with the accepted immutable retention policy | policy `8f2b5fe`, selection writer `f49ab2c` + `f1e038f`, and assessment writer `cce9ea0` accepted; replacement task resolved from its queued client ID and is active in an isolated worktree |
