...
| `01a0890c-53b1-7bf1-a6b3-59addda5b722` (`1747`, replacement for inactive `01a0881b-85ce-7f43-91d5-dd84fe064064`) | F9 audit-retention repair | `ManualPaymentProofUrlIssuer.php` plus its focused feature test only | Repair split clock in manual-payment proof URL commit `6610392` | Review rejected the first repair because URL expiry and audit retention sampled time separately. A one-anchor correction covering URL TTL, context, occurred-at, and five-year expiry is active; commit remains unintegrated and remaining inventory stays unassigned |
