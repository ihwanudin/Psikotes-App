...
// IstSubtestScreen 8017, KraepelinRunner 8018).
const port = Number(process.env.IST_ASSESSMENT_RUNNER_FIXTURE_PORT) || 8019;
...
export default defineConfig({
    ...
    build: {
        outDir: `${project}/storage/app/private/verification/ist-assessment-runner`,
        emptyOutDir: false,
    },
});
