...
| F5 typed signing composer integration | unassigned | Signing composer/policy and assigned unit/integration tests only | Replace raw recommendation/G7/override booleans with typed reviewed-decision and G7 set; replay all four P1 probes | ready after `2ac749f` + `3dac6c5`; persistence authority remains separate |
