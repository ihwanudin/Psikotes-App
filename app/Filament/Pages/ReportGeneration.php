...
final class ReportGeneration extends Page
{
    ...
    private const GAP_LABELS = [
        ...
        SignedReportDataset::FACILITY_NAME_MISSING => 'Nama fasilitas layanan psikologi belum dikonfigurasi.',
        SignedReportDataset::FACILITY_ADDRESS_MISSING => 'Alamat fasilitas layanan psikologi belum dikonfigurasi.',
