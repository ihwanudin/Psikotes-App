    ...
    public function store(Request $request, string $case, RlsContextRunner $runner): JsonResponse
    {
        ...
        $row = $runner->runAsService(function () use ($caseId, $result): object {
            ...
            DB::table('bilingual_narrative_versions')->insert([
                ...
                'cluster_a_id' => $result['clusters']['A']['id']['narrative'],
                'cluster_a_jp' => $result['clusters']['A']['jp']['narrative'],
                'cluster_b_id' => $result['clusters']['B']['id']['narrative'],
                'cluster_b_jp' => $result['clusters']['B']['jp']['narrative'],
                'cluster_c_id' => $result['clusters']['C']['id']['narrative'],
                'cluster_c_jp' => $result['clusters']['C']['jp']['narrative'],
                'cluster_d_id' => $result['clusters']['D']['id']['narrative'],
                'cluster_d_jp' => $result['clusters']['D']['jp']['narrative'],
