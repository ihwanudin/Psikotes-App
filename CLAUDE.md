...
- Durasi resmi instrumen (keputusan psikolog/pemilik proyek 2026-09-21, direvisi 2026-09-22): **PAPI 40 menit, batas waktu keras** (naik dari 30 — psikolog: PAPI Kostick aslinya tanpa batas waktu dan idealnya wajib dijawab semua; 40 menit dipilih sebagai kompromi, bukan dihapus). **RMIB: tanpa batas waktu keras untuk peserta, tapi sistem tetap punya deadline server yang generous (60 menit) sebagai backstop teknis** (bukan 15 menit lagi) — instruksi ke peserta bilang "tidak ada batas waktu, biasanya selesai sekitar 20 menit", dan tampilan hitung-mundur di halaman tes tetap memakai `remaining_seconds` dari server apa adanya (jangan bikin logika timer terpisah di klien), cuma jadi lebih longgar. IST subtes ME total 540 detik dengan pembagian **180 detik menghafal + 360 detik menjawab** (dua fase timer, bukan satu).
