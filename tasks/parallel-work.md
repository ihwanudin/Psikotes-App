...
| `01a0881b-86ec-7fc1-b0f3-99e1e5b99cb1` (`fa77`) | F2 allocator core | New allocator action and focused SQLite tests only; no migration/route/controller/production authority | Repair the remaining scoped PHPStan literal-string failure in the rollback trigger fixture without suppression or weakening the test | `f6a6f48` + retry proof `58a0a81` remain unaccepted. Independent PHPUnit is green at 152/471 and retry coverage now proves the allowlist/bound/cleanup, but PHPStan level 7 fails at focused test line 248. Multi-case/retest history and ADR-0030 route wiring remain explicitly outside this slice |
