...
| `01a0881b-86ec-7fc1-b0f3-99e1e5b99cb1` (`fa77`) | F2 allocator core | New allocator action and focused SQLite tests only; no migration/route/controller/production authority | Completed; wait for a dependency-safe increment after definition authority is frozen | Worker `f6a6f48` + `58a0a81` + `0a24f96` accepted as coordinator `f475a56` + `e07f2ad` + `55d0a59`: atomic first-attempt session/grant/source transition, exact replay, DASS-before-SQL rejection, rollback, retry allowlist/bound, and context cleanup. Independent 152/471, PHPStan 0, Pint/diff clean. Multi-case/retest and ADR-0030 route wiring remain outside this unwired slice |
