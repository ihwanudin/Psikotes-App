...
| `01a0881b-85ce-7f43-91d5-dd84fe064064` (`13aa`) | F9 retention policy | Retention policy and one audited writer at a time; no migration/delete/scheduler | Continue only through existing five-year audit writers with proven privacy/idempotency | policy `8f2b5fe`, selection writer `f49ab2c` + `f1e038f`, and assessment writer `cce9ea0` accepted; latest independent gate 9/80 focused + 9/13 retention with PHPStan/Pint green; invitation writer audit active |
