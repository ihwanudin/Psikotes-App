...
| F2 test-session grant schema `000700` | `/root/verify_pg_history` | Sole serial migration owner plus new SQLite/PostgreSQL schema-security tests and explicit runner registration | Add immutable typed grant binding for future allocator dual-write without guessing historical sessions | provisional `dea05e2`; SQLite 46/278 and static gates green, PostgreSQL unknown after repeated disposable Docker bind-I/O stalls |
