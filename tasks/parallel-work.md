...
| `01a0890c-53b1-7bf1-a6b3-59addda5b722` (`1747`, replacement for inactive `01a0881b-85ce-7f43-91d5-dd84fe064064`) | F9 notification retention | `DeliverParticipantActivation.php` and `ParticipantActivationDeliveryTest.php` only; no migration/outbox schema/scheduler | Replace the last ad-hoc five-year notification-audit expiry with one immutable UTC RetentionPolicy anchor while preserving delivery/retry/idempotency semantics | Invitation result `a2f5839` from baseline `a091c4a` accepted as coordinator `4f98dd0`; independent invitation + Retention 15/81, PHPStan 0, Pint/diff clean. Next isolated notification increment dispatched from the clean worker result |
