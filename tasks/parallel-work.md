...
|---|---|---|---|---|
| `01a0881b-8590-7123-a9ce-640f7cbf75c3` (`2469`) | F2 PostgreSQL and snapshot migration | Sole migration owner plus PostgreSQL concurrency design; no allocator implementation | Freeze the future allocator concurrency harness and anti-flake barriers read-only; do not write tests before the core allocator is accepted | `000700` accepted as `b7e5c1b`; snapshot EXPAND accepted as `427b4ce` + `d268db1`; CONTRACT preflight confirms no production dual-writer exists and enforcement remains deferred; concurrency audit active |
