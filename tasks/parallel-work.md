...
| `01a0890c-53b1-7bf1-a6b3-59addda5b722` (`1747`, implementation resumed by `/root/rereview_f9_manual_proof`) | F9 audit-retention repair | `ConsumeCheckoutHandoffTransaction.php` plus its focused feature test only | Replace its hard-coded two-year audit expiry with the five-year Audit policy without changing handoff TTL | Manual proof `6610392` + `855b780` was integrated as `8160eed` + `88cf854` (main 12/37). Assessment-bill proof `ece6ce8` was integrated as `c0d3922` (main 22/99). Organization-bill proof `7a05e84` was independently accepted and integrated as `5c264ce` (main 13/88). All three have PHPStan 0 and green Pint/diff gates. Handoff-consume retention is active from worker baseline `7a05e84`; no route, migration, or live integration ownership |
